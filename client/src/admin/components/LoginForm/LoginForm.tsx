...
import { useLoginFormik } from "../../../common/utils/formik";
...
const LoginForm = () => {
	...
	return (
		<div id="LoginForm">
			...
			<form onSubmit={formik.handleSubmit}>
				<div className="form-group login-form">
					...
					<input
						...
						className={formik.touched.loginFormEmail && formik.errors.loginFormEmail ? "input-error" : ""}
					/>
					...
					<input
						...
						onBlur={formik.handleBlur}
						className={
							formik.touched.loginFormPassword && formik.errors.loginFormPassword ? "input-error" : ""
						}
					/>
			...
			{submitSuccessStatus && <p className="form-success">{submitSuccessStatus}</p>}
		</div>
	);
};
